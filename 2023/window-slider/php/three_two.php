...
<?php
    ...
    $file1=fopen($_REQUEST["file2_1"],"r");
    $len1 = filesize($_REQUEST["file2_1"]);
    
    $file2=fopen($_REQUEST["file2_2"],"r");
    $len2 = filesize($_REQUEST["file2_2"]);

    echo "Successfully transferred contents <br>of : \"".$_REQUEST["file2_1"]."\" and \"".$_REQUEST["file2_2"]."\"<br>to : \"".$_REQUEST["file2_3"]."\"";
    echo "<br><br>File size of \"".$_REQUEST["file2_1"]."\" = ".$len1." kb";
    echo "<br>And that of \"".$_REQUEST["file2_2"]."\" = ".$len2." kb";
    
    file_put_contents($_REQUEST["file2_3"],file_get_contents($_REQUEST["file2_1"]));
    file_put_contents($_REQUEST["file2_3"],"\n".file_get_contents($_REQUEST["file2_2"]),FILE_APPEND | LOCK_EX);
