...
<?php
    ...
    $file1=fopen($_REQUEST["file5_1"],"r");
    $len = filesize($_REQUEST["file5_1"]);
    
    $radio_val = $_REQUEST["five_radio"];

    echo "Contents of : \"".$_REQUEST["file5_1"]."\"<br>have been ";
    if(strcmp($radio_val,"small")==0)
        echo "lower cased";
    else    echo "capitalized";
    echo "<br> and stored to : \"".$_REQUEST["file5_2"]."\"";
    echo "<br><br>File size of \"".$_REQUEST["file5_1"]."\" = ".$len." kb";
    
    if(strcmp($radio_val,"small")==0)
        file_put_contents($_REQUEST["file5_2"],"\n".strtolower(file_get_contents($_REQUEST["file5_1"])),FILE_APPEND | LOCK_EX);
    else    file_put_contents($_REQUEST["file5_2"],"\n".strtoupper(file_get_contents($_REQUEST["file5_1"])),FILE_APPEND | LOCK_EX);
