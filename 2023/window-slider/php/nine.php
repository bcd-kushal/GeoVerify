        ...
        <section>
            ...
            <div class="card" style="min-height: 70vh;">
                ...
                <?php
                    ...
                    $file1=fopen($_REQUEST["file9_1"],"r");
                    $len = filesize($_REQUEST["file9_1"]);
                    
                    $word_to_replace = $_REQUEST["file9_3"];
                    $word_to_replace_with = $_REQUEST["file9_4"];



                    $str=file_get_contents($_REQUEST["file9_1"]);
                    echo "<b>\"".$_REQUEST["file9_1"]."\"</b> : <br>".$str;
                    ...
                    for($i=0;$i<=strlen($str)-1;$i++){
                        ...
                        if($str[$i]==' ' || $str[$i]==',' || $i==strlen($str)-1){
                            if(strcmp($substr,$word_to_replace)==0)
                                $count++;
                            $substr="";
                        }
                    ...
                    $str=str_replace($word_to_replace,$word_to_replace_with,$str);
            
                    echo "<br><br>Search Pattern = ".$word_to_replace;
                    echo "<br>Replacement Pattern = ".$word_to_replace_with;

                    file_put_contents($_REQUEST["file9_2"], $str, FILE_APPEND | LOCK_EX);

                    echo "<br><br><b>Replaced string</b> : <br>".$str;

                    echo "<br><br>Number of times pattern found and replaced = ".$count;
